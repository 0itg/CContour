      ...
      sizer(7, 3, 0, 0)
{
    ...
    std::string ImFilter   = "PNG files (*.png)|*.png|BMP files "
    ...
    inputAnimFile.Create(
        this, wxID_ANY, inputFileName, "Export " + *type + "...", *filter,
    ...
    outputAnimFile.Create(
        this, wxID_ANY, outputFileName, "Export " + *type + "...", *filter,
        wxDefaultPosition, wxDefaultSize,
        wxFLP_SAVE | wxFLP_OVERWRITE_PROMPT | wxFLP_USE_TEXTCTRL);
    ...
    xResCtrl.Create(this, wxID_ANY, std::to_string(clientSize.x),
                    wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10000,
                    clientSize.x);
    ...
    if (animation)
    {
        ...
        durCtrl.Create(this, wxID_ANY, std::to_string(defaultDur),
                       wxDefaultPosition, xResCtrl.GetSize(), wxSP_ARROW_KEYS,
                       0, 10000, defaultDur);
        sizer.Add(&durCtrl, flagsRight);
        sizer.AddSpacer(0);
        fpsLabel.Create(this, wxID_ANY, "Frame Rate: ");
        sizer.Add(&fpsLabel, flagsLeft);
        fpsCtrl.Create(this, wxID_ANY, "30", wxDefaultPosition,
                       xResCtrl.GetSize(), wxSP_ARROW_KEYS, 1, 1000, 30);
